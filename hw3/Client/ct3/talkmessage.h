#ifndef TALKMESSAGE_H
#define TALKMESSAGE_H
...
class talkmessage : public QWidget
{
    Q_OBJECT

public:
    explicit talkmessage(QWidget *parent = nullptr,QString iconid="girl",QString iconid_slef="boy");
    ~talkmessage();
    enum msg_type{//消息种类
        user_self,
        user_other,
